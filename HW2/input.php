...
<body>
    <main>      
        <form action="summary.php" method="get">
          <p>
          Name<br>
          <!-- Holy hell this works. I took way too long on this through sheer misunderstanding the assignment -->
          <input type="input" id="name" name="name" placeholder="Name" value="<?php if($_GET){echo $_GET['name'];} ?>">
          </p>
          <p>
          Major<br>
